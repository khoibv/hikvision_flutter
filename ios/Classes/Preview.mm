...
int startPreview(int iUserID, int iStartChan, UIView *view, int iIndex)
{
    ...
    if(gInsideDecode)
    {
        ...
        if (g_structHandle[iIndex].iPreviewID == -1)
        {
            ...
            NSLog(@"ID %d", g_structHandle[iIndex].iPreviewID);
...
//            }
    ...
    else
    {
        ...
        struPreviewInfo.dwStreamType = 1;
        struPreviewInfo.bBlocked = 1;
        g_structHandle[iIndex].pView = view;
